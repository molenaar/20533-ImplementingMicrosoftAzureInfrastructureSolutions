...
3. In the  **ResDevWebRG** blade, in the **Resources** tile, click the **ResDevWebNSG1** entry representing the network security group (with the icon in the form of a shield). This will open the corresponding blade along with its **Settings** blade.

4. In the  **Settings** blade of the **ResDevWebNSG1** network security group, click **Inbound security rules**.
...
4. In the  **Settings** blade of **ResDevWebNSG2** network security group, click **Inbound security rules**.
